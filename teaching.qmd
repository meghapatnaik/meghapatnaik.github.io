...
This course covers an array of possibilities in free and commercial imagery for applications in economic research and industry. The course starts from the physics foundations of how satellites see the earth, examine measurement opportunities at all frequencies, show a variety of research applications, and carry the student to the point of writing code in Julia for one small problem. [Syllabus](misc/info/Economics_from_Outer_Space_Syllabus.pdf).
:::
:::
