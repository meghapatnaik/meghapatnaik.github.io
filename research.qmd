...
<button class="abstract-toggle" data-abstract-id="abs-remote">▷ Abstract</button> [Paper](research/remote_work_jsis.pdf)
...
(with Aishwarya Kamboj)\
<button class="abstract-toggle" data-abstract-id="abs-gst">▷ Abstract</button> [CEPR Discussion Paper](research/gst_prowess.pdf) [Ideas for India](https://www.ideasforindia.in/topics/macroeconomics/how-the-gst-created-a-formalisation-cascade) [आइडियाज़ फ़ॉर इंडिया](https://www.ideasforindia.in/topics/macroeconomics/how-the-gst-created-a-formalisation-cascade-hindi) [The Wire](https://thewire.in/economy/how-the-gst-created-a-formalisation-cascade)
<div class="abstract-content" id="abs-gst" style="max-height: 0px;">
We study India's 2017 Goods and Services Tax (GST) to examine how self-enforcing tax design generates formalization cascades through supply chains. GST created incentives for formal procurement by allowing input tax credits only for purchases from registered suppliers. Using firm-level data on 12,024 firms, we find that firms at the mean pre-reform exposure to non-creditable taxes increased documented input purchases by 6 percent while reducing tax payments by 8 percent. Effects double over five years, consistent with formalization propagating sequentially upstream—a dynamic pattern that provides the first empirical evidence on the dynamics of VAT-driven formalization cascades. At the aggregate level, large firms' share of national GST collections fell from 46 to 30 percent, implying smaller enterprises entering the formal tax net. The interquartile range of effective tax rates collapsed by 72 percent, reflecting the replacement of heterogeneous cascading taxes with uniform credits.
</div>
...
<button class="abstract-toggle" data-abstract-id="abs-female">▷ Abstract</button> [Paper](research/flexible_work_female_occupations.pdf) [Slides](research/female_hs_ls.pdf)
...
*Presentations: Society for Economic Dynamics Annual Meeting\*, Barcelona Summer Forum\*, FAU/IAB Macro Labor Workshop\* (2026); Hoover-SIEPR Conference on Remote Work, LUISS University (2025).*
...
**How Firms Pay for Energy Abatement: Evidence from India's Tradable Intensity Standard**\
<button class="abstract-toggle" data-abstract-id="abs-patasi">▷ Abstract</button> [Slides](research/small_is_clean_slides.pdf)
...
*Presentations: Yale Firms, Trade, and Development Conference; 8th EBRD–CEPR Research Symposium "The Frontiers of Finance in Emerging Markets" (2026).*
...
Can bankruptcy reform change firm behaviour even among firms that never enter bankruptcy? We study India's Insolvency and Bankruptcy Code (IBC), enacted in 2016, which created a credible threat that defaulting promoters would lose control of their firms. Using a panel of 36,217 private Indian firms from the CMIE Prowess database over FY2010–2025, we find that firms with high pre-IBC leverage cut investment by 1.6 percentage points and improved return on assets by 3.6 percentage points relative to low-leverage firms after the reform. The baseline leverage coefficient is not significant due to mean reversion, but three independent corrections—firm-specific linear trends, first differences, and long differences—all recover significant deleveraging. Effects intensify after Section 29A barred defaulting promoters from rebidding (November 2017) and persist during the COVID suspension of IBC filings (FY2020–21), consistent with structural behavioural change. The findings suggest that the benefits of bankruptcy reform extend far beyond resolved cases.
</div>
...
<button class="abstract-toggle" data-abstract-id="abs-gvc">▷ Abstract</button>
<div class="abstract-content" id="abs-gvc" style="max-height: 0px;">
...
(with Jon Hartley)\
<button class="abstract-toggle" data-abstract-id="abs-legal">▷ Abstract</button>
<div class="abstract-content" id="abs-legal" style="max-height: 0px;">
We study the effect of legal origin on firm-level outcomes using a unique natural experiment in the United Arab Emirates. The UAE mainland operates under civil law rooted in the French/Egyptian tradition, while two financial free zones—the Dubai International Financial Centre (DIFC, est. 2004) and the Abu Dhabi Global Market (ADGM, est. 2015)—operate under English common law with independent courts and regulatory frameworks. Using firm-level data from Bureau van Dijk's ORBIS database covering approximately 9,000 UAE firms, we compare firms incorporated under common law versus civil law within the same country, holding constant macroeconomic conditions, culture, and geography. We examine differences in firm size, capital structure, profitability, ownership concentration, and industry composition. Preliminary results suggest that common-law free zones attract disproportionately more financial and professional services firms, with differences in leverage and ownership structure consistent with the predictions of the legal origins literature.
</div>

**Import Competition and Product Innovation: Evidence from Indian Manufacturing**\
<button class="abstract-toggle" data-abstract-id="abs-china">▷ Abstract</button>
<div class="abstract-content" id="abs-china" style="max-height: 0px;">
...
(with Claudia Nobile)\
<button class="abstract-toggle" data-abstract-id="abs-mgmt-innov">▷ Abstract</button>
<div class="abstract-content" id="abs-mgmt-innov" style="max-height: 0px;">
...
*Presentations: Italian Macro with Micro Data Workshop, University of Naples Federico II (planned).*
...
<button class="abstract-toggle" data-abstract-id="abs-remotewomen">▷ Abstract</button>
<div class="abstract-content" id="abs-remotewomen" style="max-height: 0px;">
